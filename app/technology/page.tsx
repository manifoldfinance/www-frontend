...
export default function TechnologyPage() {
  return (
    <div className="min-h-screen bg-blackA12 text-white">
      <BackgroundPaths title="Our Technology|" subtitle="Learn about the technology powering our solutions" />
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-blackA6 p-6 rounded-lg">
            ...
            <p className="text-mauveA11">Description of the technology behind our staking solutions...</p>
          </div>
          <div className="bg-blackA6 p-6 rounded-lg">
