  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 py-12">
      {features.map((feature, index) => (
        ...
        >
          <div
            className="w-12 h-12 rounded-lg bg-[#31C4B9]/10 flex items-center justify-center mb-4"
            aria-hidden="true"
          >
            <feature.icon className="w-6 h-6 text-[#31C4B9]" />
          </div>
          <h3 id={`feature-title-${index}`} className="text-lg font-semibold text-white mb-2">
            {feature.title}
          </h3>
